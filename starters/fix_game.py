...
def start_game():
    ...
    max_attempts = 10
    attempts += 1 # inside the loop thing after the thing goes into the good guess, you know what I mean?
    game_over = False
    while not game_over:
      ...
      # Apparently we don't need that since we don't need to continue
start_game()